          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <div className="charter-email-example p-4 rounded shadow-sm">
                ...
                <p>Visit <a href="https://sailorsfeast.com" target="_blank" rel="noopener noreferrer">sailorsfeast.com</a> or call +385 95 539 9166 to place your order.</p>
          ...
          <div className="row justify-content-center text-center">
            <div className="col-md-4 mb-4 mb-md-0">
              <div className="charter-contact-method p-4 h-100">
                ...
                <a href="tel:+385955399166" className="btn btn-outline-secondary btn-sm">
                  +385 95 539 9166
                </a>
              </div>
            </div>
