...
const Success = lazy(() => import('./pages/cart-checkout/checkout/success-pages/VivaSuccess'));
const Failure = lazy(() => import('./pages/cart-checkout/checkout/success-pages/Failure'));
const PayPalSuccess = lazy(() => import('./pages/cart-checkout/checkout/success-pages/PayPalSuccess'));
const CashPaymentSuccess = lazy(() => import('./pages/cart-checkout/checkout/success-pages/CashPaymentSuccess'));
